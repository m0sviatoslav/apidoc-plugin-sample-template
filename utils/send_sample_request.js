  ...
  function sendSampleRequest(group, name, version, type)
  {
      ...
      $root.find(".sample-request-header:checked").each(function(i, element) {
          ...
          $root.find("[data-sample-request-header-group=\"" + group + "\"]").each(function(i, element) {
            ...
            header[key] = getNormalizedValue(element);
          });
      });
      ...
      $root.find(".sample-request-param:checked").each(function(i, element) {
          ...
          $root.find("[data-sample-request-param-group=\"" + group + "\"]").not(function(){
            ...
            param[key] = getNormalizedValue(element);
            paramType[key] = $(element).next().text();
          });
      });

      function getNormalizedValue(element) {
      ...
      if ('GET' !== type.toUpperCase()) {
          var bodyParam = JSON.stringify(param);
      }
